...
class testSiiter3 extends Component{
    render(){
        return(
            <div>
                ...
                <div id={"start-app"} class="start-app">
                    <MDBBtn id={"button"}rounded color="primary" size="lg" href={"testSitter4"}>Start Creating Your Profile</MDBBtn>
                </div>
